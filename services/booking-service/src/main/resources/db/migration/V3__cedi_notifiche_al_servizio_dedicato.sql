-- ============================================================================
-- Le notifiche passano a notification-service, che possiede la propria tabella nel
-- proprio database.
--
...
-- di notification-service. Sul database di sviluppo, oggi vuoto, non c'e' nulla da salvare.
-- ============================================================================
