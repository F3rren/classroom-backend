...
public class NotificaController {
    ...
    NotificaController(NotificaService notificaService) {
        this.notificaService = notificaService;
    }

    @GetMapping
    @Operation(summary = "Notifiche dell'utente autenticato")
    public ResponseEntity<List<Notifica>> getNotifiche(@AuthenticationPrincipal AppPrincipal principal) {
    ...
    public ResponseEntity<List<Notifica>> getNotificheNonLette(@AuthenticationPrincipal AppPrincipal principal) {
