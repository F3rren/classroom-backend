...
public class PrenotazioneInternaController {

    private static final Logger logger = LoggerFactory.getLogger(PrenotazioneInternaController.class);

    private final IPrenotazioneRepository prenotazioneRepository;

    PrenotazioneInternaController(IPrenotazioneRepository prenotazioneRepository) {
